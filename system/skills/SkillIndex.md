...
| forge | 4 | system/skills/forge/index.md | capability gap, no skill for goal, skill evolution, mass re-attestation after gemma upgrade | system/skills/forge/base.md |
...
| forge-generate-agent | forge/generate | forge-generate-agent | high |
| forge-evolve-agent | forge/evolve | forge-evolve-agent | high |
| forge-validate-agent | forge/validate | forge-validate-agent | medium |
| forge-compile-cartridge-tool | forge/compile | _(tool)_ | low |
